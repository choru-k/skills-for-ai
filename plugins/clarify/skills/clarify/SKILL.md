---
name: clarify
description: Turn ambiguous requests into clean, actionable specifications. Use for "clarify", "clarify requirements", "this is vague", "make this clean", "spec this out", "scope this", or when the user's intent is unclear.
user-invocable: true
