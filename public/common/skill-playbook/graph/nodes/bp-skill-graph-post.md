...
- [x] Add lightweight checks for broken links and missing metadata (`scripts/graph-qa.sh`)
...
- Follow-ups:
  ...
  - completed rollout on `work-ticket` (2026-02-19)
  - wired graph QA into periodic review cadence and pre-commit (2026-02-19)
  - wired graph QA into CI (`.github/workflows/graph-qa.yml`) (2026-02-20)
  - completed rollout on `complete-prompt` and `call-ai` (2026-02-20)
  - completed rollout on `choru-ticket` and `work-workspace` (2026-02-20)
  - extracted shared contracts into `skill-commons` and linked reuse points (2026-02-20)
  - graph QA now validates path-based cross-skill links (2026-02-20)
